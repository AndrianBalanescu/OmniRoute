...
BUILD_MEMORY="${OMNIROUTE_DEPLOY_BUILD_MEMORY:-8g}"
BUILD_SWAP="${OMNIROUTE_DEPLOY_BUILD_MEMORY_SWAP:-8g}"
BUILD_HEAP_MB="${OMNIROUTE_DEPLOY_BUILD_HEAP_MB:-4096}"
USE_TURBOPACK="${OMNIROUTE_DEPLOY_USE_TURBOPACK:-0}"
PULL_BASE_IMAGE="${OMNIROUTE_DEPLOY_PULL:-0}"
MIN_AVAILABLE_MB="${OMNIROUTE_DEPLOY_MIN_AVAILABLE_MB:-8192}"
