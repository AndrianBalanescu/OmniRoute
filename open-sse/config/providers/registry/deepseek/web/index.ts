...
export const deepseek_webProvider: RegistryEntry = {
  ...
  authHeader: "bearer",
  models: [
    { id: "deepseek-v4-pro", name: "DeepSeek V4 Pro", toolCalling: true, supportsTools: true },
    {
    ...
    { id: "deepseek-v4-flash", name: "DeepSeek V4 Flash", toolCalling: true, supportsTools: true },
    {
    ...
    { id: "deepseek-chat", name: "DeepSeek Chat", toolCalling: true, supportsTools: true },
    {
    ...
    { id: "DeepSeek-V3.2", name: "DeepSeek V3.2", toolCalling: true, supportsTools: true },
    { id: "DeepSeek-Search", name: "DeepSeek Search", toolCalling: true, supportsTools: true },
  ],
};
